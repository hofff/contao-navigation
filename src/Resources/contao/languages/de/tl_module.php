...
$GLOBALS['TL_LANG']['tl_module']['hofff_navigation_root_legend']
    = 'Konfiguration der Wurzelseiten';
$GLOBALS['TL_LANG']['tl_module']['hofff_navigation_legend']
    = 'Navigations-Einstellungen';

$GLOBALS['TL_LANG']['tl_module']['hofff_navigation_start']
    = ['Startebene', 'Relativ zu den Referenzseiten. Negative Werte sind möglich.'];
$GLOBALS['TL_LANG']['tl_module']['hofff_navigation_currentAsRoot']
    = ['Aktuelle Seite als Referenzseite', 'Fügt die aktuelle Seite zu den Referenzseiten hinzu.'];
...
$GLOBALS['TL_LANG']['tl_module']['hofff_navigation_respectGuests']
    = ['"Nur für Gäste sichtbar" beachten', 'Nur Relevant für die Ermittlung der Startebene.'];
$GLOBALS['TL_LANG']['tl_module']['hofff_navigation_respectHidden']
    = ['Versteckte Seiten beachten', 'Nur Relevant für die Ermittlung der Startebene.'];
$GLOBALS['TL_LANG']['tl_module']['hofff_navigation_respectPublish']
    = ['Unveröffentlichte Seiten beachten', 'Nur Relevant für die Ermittlung der Startebene.'];

$GLOBALS['TL_LANG']['tl_module']['hofff_navigation_includeStart']
    = ['Startebene anzeigen', 'Rendert die Startebene in die Navigation.'];
...
$GLOBALS['TL_LANG']['tl_module']['hofff_navigation_defineHard']
    = ['Anzahl maximal auszugebender Ebenen anpassen', 'Es werden keine Ebenen ausgegeben die tiefer liegen.'];
...
$GLOBALS['TL_LANG']['tl_module']['hofff_navigation_showProtected']
    = ['Geschützte Seiten anzeigen', 'Seiten und Unterseiten mit Mitgliedergruppen-Beschränkung anzeigen.'];
$GLOBALS['TL_LANG']['tl_module']['hofff_navigation_showHidden']
    = ['Versteckte Seiten anzeigen', 'Seiten und Unterseiten mit Option "Im Menü verstecken" trotzdem anzeigen.'];
