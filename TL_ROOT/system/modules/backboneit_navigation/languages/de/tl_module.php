...
$GLOBALS['TL_LANG']['tl_module']['bbit_nav_root_legend']
	= 'Konfiguration der Wurzelseiten';
$GLOBALS['TL_LANG']['tl_module']['bbit_nav_legend']
	= 'Navigations-Einstellungen';

$GLOBALS['TL_LANG']['tl_module']['bbit_nav_start']
	= array('Startebene', 'Relativ zu den Referenzseiten. Negative Werte sind möglich.');
$GLOBALS['TL_LANG']['tl_module']['bbit_nav_includeStart']
	= array('Startebene anzeigen', 'Rendert die Startebene in die Navigation.');
$GLOBALS['TL_LANG']['tl_module']['bbit_nav_currentAsRoot']
	= array('Aktuelle Seite als Referenzseite', 'Fügt die aktuelle Seite zu den Referenzseiten hinzu.');
$GLOBALS['TL_LANG']['tl_module']['bbit_nav_defineRoots']
...
$GLOBALS['TL_LANG']['tl_module']['bbit_nav_roots']
...
$GLOBALS['TL_LANG']['tl_module']['bbit_nav_isSitemap']
...
$GLOBALS['TL_LANG']['tl_module']['bbit_nav_addLegacyCss']
...
$GLOBALS['TL_LANG']['tl_module']['bbit_nav_disableHooks']
