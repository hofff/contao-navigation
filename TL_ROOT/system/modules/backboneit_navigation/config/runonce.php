...
// renaming backboneit_navigation_* columns into bbit_navi_*
foreach(array('tl_module') as $strTable) {
	...
	foreach($arrCreate as $strLine) {
		...
		$strLine = preg_replace('@(`backboneit_navigation_([A-Za-z]+)`)@', '$1 `bbit_navi_$2`', $strLine, 1);
